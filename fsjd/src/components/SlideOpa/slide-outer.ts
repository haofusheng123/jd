...
class SlideOpa implements slideType{
    ...
    constructor (slideOuter:HTMLElement|undefined,type:"flicker"|"roll"="flicker",autoplay:boolean=true,width?:number,time:number=300,spend:number=30){
        ...
        this.iconCon!.addEventListener("click",this.iconHandler.bind(this));
